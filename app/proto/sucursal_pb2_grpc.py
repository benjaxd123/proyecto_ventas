...
class SucursalServiceStub(object):
...
class SucursalServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_SucursalServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'sucursal.SucursalService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('sucursal.SucursalService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class SucursalService(object):
    """Missing associated documentation comment in .proto file."""

    @staticmethod
    def ValidarYGuardar(request,
            target,
            options=(),
